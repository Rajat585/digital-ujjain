...
const newsItemsHinglish = [
  {
    ...
    title:
      "Simhastha 2028 ke liye ₹18,840 crore ka infrastructure plan ghoshit",
    desc: "Sadak, ghat, aur riverfront vikas ke liye state government ne bada budget allocate kiya hai.",
  },
  {
    category: "Riverfront",
    title:
      "29-km Kshipra riverfront corridor — permanent ghats ka nirmaan jaari",
    desc: "Shipra nadi ke kinare permanent ghat banaye ja rahe hain taaki Simhastha ke baad bhi ye kaam aayein.",
  },
  {
    category: "Transport",
    title: "Naya 6-lane Indore-Ujjain highway — pragati update",
    desc: "Airport se Ujjain tak yatra aasan banane ke liye highway ko 6-lane kiya ja raha hai.",
  },
  {
    category: "Accommodation",
    title: "Accommodation booking guidelines jaari ki gayi",
    desc: "Verified stays kaise book karein, iski official guidelines aa chuki hain.",
  },
];
...
const text = {
  hi: {
    ...
    viewLink: "यहां देखें →",
    footNote:
      "सभी अपडेट आधिकारिक स्रोतों पर आधारित हैं — नवीनतम जानकारी के लिए सिंहस्थ 2028 की आधिकारिक वेबसाइट देखें।",
  },
  en: {
    title: "News & Updates",
    ...
    viewLink: "View here →",
    footNote:
      "All updates are based on official sources — check the official Simhastha 2028 website for the latest information.",
  },
  hinglish: {
    title: "News & Updates",
    ...
    footNote:
      "Sabhi updates official sources par aadharit hain — naveentam jaankari ke liye Simhastha 2028 ki adhikarik website check karein.",
  },
};
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full max-w-4xl">
        {newsItems.map((item, index) => (
          <div
            key={item.id}
            className="group relative bg-white/5 border border-ujjain-gold/30 rounded-xl p-6 flex flex-col overflow-hidden hover:border-ujjain-gold/70 hover:-translate-y-1.5 hover:shadow-[0_12px_32px_-8px_rgba(212,175,55,0.35)]"
            style={{
              opacity: visible ? 1 : 0,
              transform: visible ? "translateY(0)" : "translateY(22px)",
              transition: `opacity 0.7s ${EASE}, transform 0.7s ${EASE}, border-color 0.4s ${EASE}, box-shadow 0.4s ${EASE}`,
              transitionDelay: visible ? `${150 + index * 110}ms` : "0ms",
            }}
          >
            <span
            ...
            <div className="flex items-center justify-between mb-3">
              <span
                className={`text-xs font-semibold px-3 py-1 rounded-full border transition-transform duration-300 group-hover:scale-105 ${categoryColors[item.category.en] || "text-ujjain-gold border-ujjain-gold/30 bg-ujjain-gold/10"}`}
              >
                {item.category[lang]}
              </span>
      ...
      <p
        ...
        style={{
          ...
          transitionDelay: visible
            ? `${150 + newsItems.length * 110 + 150}ms`
            : "0ms",
        }}
      >
        {t.footNote}
