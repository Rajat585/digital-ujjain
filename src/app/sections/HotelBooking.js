  ...
  hi: [
    {
      ...
      rating: 4.3,
      reviews: 214,
      amenities: ["फ्री वाईफाई", "24x7 पानी", "साझा रसोई"],
      image:
    ...
    },
    {
      ...
      type: "सरकारी गेस्ट हाउस",
      price: 900,
      rating: 4.1,
      reviews: 356,
      amenities: ["फ्री वाईफाई", "एसी कमरे", "पार्किंग"],
      image:
    ...
    },
    {
      ...
      rating: 4.5,
      reviews: 189,
      amenities: ["फ्री वाईफाई", "एसी कमरे", "रूम सर्विस", "रेस्टोरेंट"],
      image:
    ...
    },
    {
      ...
      rating: 4.4,
      reviews: 97,
      amenities: ["फ्री वाईफाई", "घर का खाना", "फैमिली फ्रेंडली"],
      image:
    ...
    },
    {
      ...
      rating: 4.2,
      reviews: 143,
      amenities: ["फ्री वाईफाई", "एसी कमरे", "मंदिर से नज़दीक"],
      image:
    ...
    },
    {
      ...
      rating: 4.0,
      reviews: 62,
      amenities: ["साझा बाथरूम", "सामूहिक भोजन", "सुरक्षा गार्ड"],
      image:
...
const text = {
  hi: {
    ...
    title: "स्टे बुकिंग",
    subtitle:
      "उज्जैन में सत्यापित ठहराव — निश्चित सरकारी-सत्यापित मूल्य, शून्य कमीशन",
    trustBar: "सरकारी सत्यापित मूल्य  •  शून्य कमीशन — सीधी बुकिंग",
    howVerified: "सत्यापन कैसे होता है?",
    howVerifiedText:
      "हर प्रॉपर्टी का लाइसेंस और मूल्य उज्जैन नगर निगम की टीम द्वारा भौतिक रूप से जांचा गया है। रेट लिस्ट पंजीकृत है — कोई भी अतिरिक्त शुल्क अवैध है। किसी भी गड़बड़ी की रिपोर्ट सीधे प्रशासन तक जाती है।",
    checkIn: "चेक-इन",
    checkOut: "चेक-आउट",
    guests: "मेहमान",
    nightsLabel: (n) => `${n} रात${n > 1 ? "ें" : ""}`,
    verified: "सत्यापित ✓",
    reviews: "रिव्यू",
    perNight: (price, n) => `₹${price}/रात × ${n} रात${n > 1 ? "ें" : ""}`,
    bookNow: "बुक करें",
    guestName: "मेहमान का पूरा नाम",
    mobile: "मोबाइल नंबर",
    taxesFees: "टैक्स और फीस",
    ...
    close: "बंद करें",
    secureBadge: "🔒 Razorpay के ज़रिए सुरक्षित भुगतान",
    verifiedBadge: "✓ सत्यापित होटल",
