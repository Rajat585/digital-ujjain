...
const text = {
    hi: {
        ...
        reachTrainDesc: "उज्जैन जंक्शन — दिल्ली, मुंबई, अहमदाबाद से सीधी ट्रेनें। सिंहस्थ के दौरान विशेष ट्रेनें भी चलेंगी।",
        reachAir: "हवाई यात्रा",
        reachAirDesc: "सबसे नज़दीकी हवाई अड्डा इंदौर (देवी अहिल्याबाई होल्कर एयरपोर्ट), उज्जैन से लगभग 55-65 किमी दूर है। वहां से टैक्सी/बस से आसानी से पहुंचा जा सकता है।",
        reachRoad: "सड़क मार्ग",
        reachRoadDesc: "एनएच52 से अच्छी तरह जुड़ा हुआ। इंदौर-उज्जैन हाईवे 2028 तक 6-लेन हो जाएगा। नियमित सरकारी और निजी बसें उपलब्ध हैं।",
        foodTitle: "खान-पान",
        foodDesc: "केवल अधिकृत/सत्यापित स्टॉल से ही खाना-पानी लें। महाकाल का प्रसाद और उज्जैन की पारंपरिक मिठाइयां ज़रूर आज़माएं।",
        transportTitle: "स्थानीय परिवहन",
        transportDesc: "ऑटो-रिक्शा और टैक्सी स्थानीय यात्रा के लिए आसानी से मिल जाएंगे। बस स्टैंड और रेलवे स्टेशन हमारे इंटरैक्टिव मानचित्र पर पहले से चिह्नित हैं।",
        transportLink: "मानचित्र पर देखें →",
        parkingTitle: "पार्किंग",
        parkingDesc: "सिंहस्थ 2028 के लिए 500 एकड़ का समर्पित पार्किंग ज़ोन योजनाबद्ध है। नानाखेड़ा क्षेत्र मानचित्र पर 'पार्किंग ज़ोन' टैग के साथ चिह्नित है।",
        accommodationTitle: "ठहरने की जगह",
        accommodationDesc: "सत्यापित ठहराव और सरकारी-सत्यापित मूल्य के साथ पूरी सूची हमारे स्टे बुकिंग सेक्शन में उपलब्ध है।",
        ...
        footNote: "यह जानकारी योजना बनाने के लिए है — सिंहस्थ के दौरान स्थानीय प्रशासन के रीयल-टाइम अपडेट को प्राथमिकता दें।",
    },
    en: {
        title: "Visitor Guide",
...
const emergencyNumbers = [
    { icon: "🚓", label: { hi: "पुलिस", en: "Police", hinglish: "Police" }, number: "100" },
    { icon: "🚑", label: { hi: "एम्बुलेंस", en: "Ambulance", hinglish: "Ambulance" }, number: "108" },
    { icon: "🚒", label: { hi: "अग्निशमन", en: "Fire", hinglish: "Fire" }, number: "101" },
    { icon: "☎️", label: { hi: "पर्यटक हेल्पलाइन", en: "Tourist Helpline", hinglish: "Tourist Helpline" }, number: "1364" },
];
