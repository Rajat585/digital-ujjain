  ...
  hi: [
    {
      ...
      impact: "Is samman ne Ujjain ko Madhya Pradesh ke agraniya smart shehron mein sthapit kiya hai, aur aane wale Simhastha mahaparv ke liye ek majboot digital aadhar taiyar kiya hai.",
    },
    {
      ...
      impact: "Ye rank Ujjain ke safai vyavastha mein lagatar sudhar ko darshata hai, jo teerth-yatriyon ke liye ek saaf-suthra aur swasth anubhav sunishchit karta hai.",
    },
    {
      ...
      impact: "Ye maanyata Ujjain ki hazaaron saal purani sanskritik virasat ko sanrakshit karne ke saath-saath ise ek vishwastariya dharmik-paryatan kendra ke roop mein sthapit karti hai.",
    },
    {
      ...
      impact: "Ye puraskar Ujjain ke paryatan anubhav ko rashtriya star par pramaanit karta hai aur Simhastha 2028 ke liye ek vishwasneey aadhar taiyar karta hai.",
    },
  ],
  en: [
    {
      ...
      impact: "This award has established Ujjain among Madhya Pradesh's leading smart cities and laid a strong digital foundation for the upcoming Simhastha event.",
    },
    {
      title: "Swachh Sarvekshan Rank",
      ...
      impact: "This rank reflects Ujjain's continuous improvement in sanitation, ensuring a clean and healthy experience for pilgrims.",
    },
    {
      title: "Heritage City Recognition",
      ...
      impact: "This recognition preserves Ujjain's thousands-of-years-old cultural heritage while establishing it as a world-class religious tourism hub.",
    },
    {
      title: "Best Tourism Destination",
      ...
      impact: "This award nationally validates Ujjain's tourism experience and builds a trusted foundation for Simhastha 2028.",
    },
  ],
};

const headings = {
  hi: { title: "Ujjain Ki Uplabdhiyan", subtitle: "Shehar ko mile samman aur pehchaan" },
  en: { title: "Ujjain's Achievements", subtitle: "Recognitions and honours earned by the city" },
};

const modalLabels = {
  hi: { highlights: "Mukhya Baatein", impact: "Prabhav", awardedBy: "Pradaan Karta" },
  en: { highlights: "Key Highlights", impact: "Impact", awardedBy: "Awarded By" },
};
    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-4 py-20 bg-ujjain-dark">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-5xl">
        {achievements.map((item, index) => (
          <div
            key={index}
            className="flex flex-col items-center text-center bg-white/5 border border-ujjain-gold/30 rounded-xl p-6 hover:border-ujjain-gold hover:-translate-y-2 transition-all duration-300"
          >
            ...
            <div className="grid grid-cols-3 gap-2 mb-4 w-full">
              {item.extraStats.map((s, i) => (
                <div key={i}>
                  <div className="text-xs md:text-sm font-bold text-ujjain-gold">{s.value}</div>
                  <div className="text-ujjain-cream/50 text-[9px] md:text-[10px]">{s.label}</div>
                </div>
              ))}
            </div>
      ...
      {activeItem && (
        ...
        >
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-ujjain-gold mt-2 mb-1">{activeItem.title}</h3>
            <p className="text-ujjain-cream/70 text-sm mb-4">
              {modalLabels[lang].awardedBy}: <span className="text-ujjain-cream">{activeItem.awardedBy}</span>
            </p>
            ...
            <p className="text-ujjain-cream/90 text-sm text-left">{activeItem.impact}</p>
          </div>
        </div>
      )}
    </section>
