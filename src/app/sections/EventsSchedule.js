...
const events = [
  {
    ...
    desc: {
      ...
      hinglish:
        "Sabse mahatvapoorna snan — 13 Akhade apni shobhayatra ke saath Shipra nadi me snan karenge.",
    },
  },
  {
    id: 2,
    ...
    date: {
      hi: "23-27 April 2028",
      en: "23-27 April 2028",
      hinglish: "23-27 April 2028",
    },
    title: {
      hi: "द्वितीय शाही स्नान",
      en: "Second Shahi Snan",
      hinglish: "Dwitiya Shahi Snan",
    },
    desc: {
      ...
      hinglish:
        "Doosra pramukh Amrit Snan — bhari sankhya me shraddhalu aur Akhada processions.",
    },
  },
  {
    id: 3,
  ...
  },
  {
    ...
    date: {
      hi: "पूर्णिमा तिथि",
      en: "Purnima Tithi",
      hinglish: "Purnima Tithi",
    },
    title: {
      hi: "पूर्णिमा स्नान",
      en: "Purnima Bathing",
      hinglish: "Purnima Snan",
    },
    desc: {
      ...
      hinglish:
        "Poornima ki tithi par shubh snan — Shahi Snan se kam bheed, parivaron ke liye behtar.",
    },
  },
  {
    id: 5,
    ...
    date: {
      hi: "एकादशी तिथि",
      en: "Ekadashi Tithi",
      hinglish: "Ekadashi Tithi",
    },
    title: {
      hi: "एकादशी स्नान",
      en: "Ekadashi Bathing",
      hinglish: "Ekadashi Snan",
    },
    desc: {
  ...
  },
  {
    ...
    date: {
      hi: "अमावस्या तिथि",
      en: "Amavasya Tithi",
      hinglish: "Amavasya Tithi",
    },
    title: {
      hi: "अमावस्या स्नान",
      en: "Amavasya Bathing",
      hinglish: "Amavasya Snan",
    },
    desc: {
      ...
      hinglish:
        "Amavasya ki tithi par snan — Kalpvas kar rahe shraddhalu ke liye vishesh mahatva.",
    },
  },
  {
    id: 7,
    ...
    date: {
      hi: "मेला अवधि भर",
      en: "Throughout the mela",
      hinglish: "Mela avdhi bhar",
    },
    title: {
      hi: "अखाड़ा शोभायात्रा",
      en: "Akhada Processions",
      hinglish: "Akhada Shobhayatra",
    },
    desc: {
      ...
      hinglish:
        "13 Akhadon ki paramparik shobhayatrayein poore mela avdhi me alag-alag dinon par nikalti hain.",
    },
  },
  {
    id: 8,
    ...
    title: {
      ...
      en: "Bhajan-Kirtan Evenings",
      hinglish: "Bhajan-Kirtan Sandhya",
    },
    desc: {
      ...
      hinglish:
        "Ghaton par shaam ko niyamit bhajan-kirtan aur aarti karyakram.",
    },
  },
  {
    id: 9,
    ...
    title: {
      hi: "आध्यात्मिक प्रवचन",
      en: "Spiritual Discourses",
      hinglish: "Adhyatmik Pravachan",
    },
    desc: {
      ...
      hinglish:
        "Sadhu-santon dwara pravachan aur satsang, alag-alag pandalon me.",
    },
  },
  {
    id: 10,
    ...
    date: {
      hi: "कल्पवास अवधि",
      en: "During Kalpvas period",
      hinglish: "Kalpvas avdhi",
    },
    ...
    desc: {
      ...
      hinglish:
        "Ek mahine tak nadi-tat par rehkar tapasya aur vrat karne ki parampara.",
    },
  },
  {
    id: 11,
    ...
    desc: {
      ...
      hinglish:
        "Ujjain ke charon aur parikrama/pilgrimage circuit — kai shraddhalu is yatra ko poora karte hain.",
    },
  },
];
...
const text = {
  hi: {
    ...
    footNote:
      "सटीक तिथियां/तारीखें आधिकारिक पंचांग और प्रशासन की घोषणा के अनुसार बदल सकती हैं — सिंहस्थ के नज़दीक आधिकारिक पुष्टि ज़रूर देखें।",
  },
  en: {
    ...
    footNote:
      "Exact dates may change based on the official panchang and administration announcements — please check official confirmation closer to Simhastha.",
  },
  hinglish: {
    title: "Major Events & Schedule",
    ...
    footNote:
      "Exact tithiyan/dates official panchang aur prashasan ki ghoshna ke anusar badal sakti hain — Simhastha ke najdeek official confirmation zaroor dekhein.",
  },
};
        ...
        {filteredEvents.map((event, index) => (
          <div
            ...
            style={{
              ...
              animationName: visible ? "eventCardIn" : "none",
          ...
          >
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-ujjain-cream/50 text-xs">
                {event.date[lang]}
              </span>
            </div>
